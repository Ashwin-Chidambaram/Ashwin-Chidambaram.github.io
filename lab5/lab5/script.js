...
function depositMoney() {
    ...
    statusText.innerText =
        "You've successfully deposited $30 into your bank account!";
...
function withdrawMoney() {
    ...
    if (accountBalance >= withdrawAmount) {
        ...
        statusText.innerText =
            "You've successfully withdrawn $30 from your bank account!";
        ...
        statusText.innerText =
            "You don't have enough money to withdraw $30!";
